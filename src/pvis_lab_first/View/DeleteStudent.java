...
public class DeleteStudent {
    ...
    public DeleteStudent(Display display, Controller controller) {
        this.display = display;
        this.controller = controller;
        shell = new Shell(display);
        shell.setSize(1240, 240);
        ...
        rezult = new Label(shell, SWT.NONE);
        RowData rowDataRezult = new RowData();
        rowDataRezult.width = 400;
        rezult.setLayoutData(rowDataRezult);
        ...
        searchRecord.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                ...
                controller.deleteRecordsForFilter(searchFilter);

            }
        });
    }

    public void setRezult(int deleteRecords){
        if(deleteRecords < 1){
            rezult.setText("Записей с заданным условием найдено не было");
        }else {
            rezult.setText("Количество удалённых записей: " + deleteRecords);
        }
